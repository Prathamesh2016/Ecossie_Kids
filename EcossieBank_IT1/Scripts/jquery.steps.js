...
let timePassed1 = 0;
let timeLeft1 = TIME_LIMIT;
let timePassed2 = 0;
let timeLeft2 = TIME_LIMIT;
let timerInterval = null;
let timerInterval1 = null;
let timerInterval2 = null;
let remainingPathColor = COLOR_CODES.info.color;
let remainingPathColor1 = COLOR_CODES.info.color;
let remainingPathColor2 = COLOR_CODES.info.color;
  ...
  <svg class="base-timer__svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <g class="base-timer__circle">
      ...
      <path
        ...
        stroke-dasharray="283"
        class="base-timer__path-remaining1 ${remainingPathColor}"
        d="
          M 50, 50
          m -45, 0
          a 45,45 0 1,0 90,0
...
function resetTimer1() {
    ...
    timePassed1 = 0;
    timeLeft1 = TIME_LIMIT;
    timerInterval1 = null;
    remainingPathColor1 = "green";

    setRemainingPathColor1(TIME_LIMIT);
...
function resetTimer2() {
    ...
    timePassed2 = 0;
    timeLeft2 = TIME_LIMIT;
    timerInterval2 = null;
    remainingPathColor2 = "green";
    setRemainingPathColor2(TIME_LIMIT);
...
function startTimer1() {
    timerInterval1 = setInterval(() => {
        ...
        timeLeft1 = TIME_LIMIT - timePassed1;
        ...
        setCircleDasharray1();
        setRemainingPathColor1(timeLeft1);
...
function startTimer2() {
    timerInterval2 = setInterval(() => {
        ...
        timeLeft2 = TIME_LIMIT - timePassed2;
...
function setRemainingPathColor1(timeLeft1) {
    const { alert, warning, info } = COLOR_CODES;
...
function calculateTimeFraction1() {

    const rawTimeFraction1 = timeLeft1 / TIME_LIMIT;
    return rawTimeFraction1 - (1 / TIME_LIMIT) * (1 - rawTimeFraction1);
}
function calculateTimeFraction2() {
    const rawTimeFraction2 = timeLeft2 / TIME_LIMIT;
    return rawTimeFraction2 - (1 / TIME_LIMIT) * (1 - rawTimeFraction2);
}
...
function setCircleDasharray1() {

    const circleDasharray1 = `${(
        calculateTimeFraction1() * FULL_DASH_ARRAY
    ).toFixed(0)} 283`;
...
function setCircleDasharray2() {
    const circleDasharray2 = `${(
        calculateTimeFraction2() * FULL_DASH_ARRAY
    ).toFixed(0)} 283`;

    document
        .getElementById("base-timer-path-remaining2")
        .setAttribute("stroke-dasharray", circleDasharray2);
}